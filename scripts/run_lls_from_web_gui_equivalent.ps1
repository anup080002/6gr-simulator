param(
    [string]$BaseUrl = "",
    [string]$Scenario = "lls_3gpp_rel20_anchor_4ghz_100mhz_waveform_honest_19site_57cell_570ue_60slot.yaml",
...
if ([string]::IsNullOrWhiteSpace($RunTag)) {
    $RunTag = "webgui_rel20_4ghz_100mhz_19site_57cell_570ue_60slot_" + (Get-Date -Format "yyyyMMdd_HHmmss")
}
