...
| Later campaigns | `runAllIA.m:1-6`; `runInitialAccessC0StudyCampaign.m:1-4` | `runAllIA` always errors; the explicitly named study facade rejects non-C0. | Correct | Keep C1-C15 frozen until persisted C0 `TDOC_PASS`. |
