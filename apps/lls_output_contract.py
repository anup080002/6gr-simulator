...
REPORT_SECTIONS = [
    ...
    _s("ssb-pbch-pss-sss", "SSB / PBCH / PSS / SSS", "control_phy", "control_phy", "live_ssb_stage_table live_pbch_summary live_sync_signal_state", "SSB index timeline;PBCH stage latency;SSB/PBCH occupancy map;sync success/failure timeline if available;SSB EVM"),
