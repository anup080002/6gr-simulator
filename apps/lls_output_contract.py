...
REPORT_SECTIONS = [
    ...
    _s("csi-rs", "CSI-RS", "control_phy", "control_phy", "live_csirs_stage_table live_csirs_resource_table", "CSI-RS resource occupancy;port usage chart;CSI-RS latency trend;CSI-RS EVM;CSI-RS pilot residual"),
