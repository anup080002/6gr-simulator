...
scope = "ra_attempt";
spec = { ...
    "random_access.response_window_slots", "random_access.ra_response_window_slots", "raCfg.RAResponseWindowSlots", ra.RAResponseWindowSlots; ...
    "random_access.power_ramping_step_db", "random_access.power_ramping_step_db", "raCfg.PowerRampingStep_dB", ra.PowerRampingStep_dB; ...
    "random_access.ra_rnti_policy", "@ts_38_321_ra_rnti_formula", "raCfg.RARNTI", "ts_38_321_ra_rnti_formula"; ...
    "random_access.prach_occasion_policy", "@ts_38_211_configuration_index_resolution", "raCfg.PRACHOccasionResolution", "ts_38_211_configuration_index_resolution"};
for i = 1:size(spec, 1)
