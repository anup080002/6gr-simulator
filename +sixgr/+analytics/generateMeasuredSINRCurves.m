...
for gi = 1:numel(groupMasks)
    ...
    for bi = 1:numel(bins.centers)
        ...
        throughputRows{end+1, 1} = localThroughputCurveRow(binSub, direction, ueLabel, bins, bi, sourceArtifact, bandwidthHz, tddEfficiency, slotDuration_s); %#ok<AGROW>
    end
    ...
    summaryRows{end+1, 1} = localMeasuredSummaryRow(sub, direction, ueLabel, sourceArtifact, bandwidthHz, tddEfficiency, slotDuration_s); %#ok<AGROW>
...
function row = localThroughputCurveRow(T, direction, ueLabel, bins, binIdx, sourceArtifact, bandwidthHz, tddEfficiency, slotDuration_s)
n = height(T);
...
function row = localMeasuredSummaryRow(T, direction, ueLabel, sourceArtifact, bandwidthHz, tddEfficiency, slotDuration_s)
n = height(T);
...
types = ["string","string","double","double","double","double","double","double","double","double","double", ...
    "double","double","double","double","double","double","double","string","double","double","double","string","string"];
end
...
types = ["string","string","string","double","string","logical","double","double","double","double","double", ...
    "double","double","double","double","double","double","double","double","string","logical","string","string","string"];
end
