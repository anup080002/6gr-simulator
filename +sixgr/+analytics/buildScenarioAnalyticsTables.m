...
for i = 1:height(Tin)
    ...
    r.Throughput_Mbps = localValue(r0, "Throughput_Mbps", NaN);
    ...
    r.RankSelectionPolicy = string(localValue(r0, "RankSelectionPolicy", ""));
    r.RankSelectionSource = string(localValue(r0, "RankSelectionSource", ""));
    r.RankDecisionReason = string(localValue(r0, "RankDecisionReason", ""));
    r.RankDowngradeApplied = localValue(r0, "RankDowngradeApplied", NaN);
    r.MaxSupportedLayers = localValue(r0, "MaxSupportedLayers", NaN);
...
vars = ["UEIndex","RNTI","Slot","Frame","Direction","MCS","PRBs","TBSBits","Layers","Modulation","CodeRate", ...
    ...
    "WidebandCQI","PMI","RankIndicator","RankSelectionPolicy","RankSelectionSource","RankDecisionReason", ...
    "RankDowngradeApplied","MaxSupportedLayers","SelectedBeamIndex","BestBeamIndex","BeamHit","BeamGainGap_dB","ConditionNumber_dB", ...
