...
mappings = {
    ...
    "run.total_time_ms", "run_control.total_time_ms", "identity"
    ...
    "antenna.bs_panel_count", "antenna_and_array.bs_panel_count", "identity"
    "antenna.ue_panel_count", "antenna_and_array.ue_panel_count", "identity"
    ...
    "scheduler.coverageOutageGuardEnabled", "system.scheduler.coverageOutageGuardEnabled", "identity"
    "scheduler.minSchedulingSINR_dB", "system.scheduler.minSchedulingSINR_dB", "identity"
    ...
    "reference_signals.csi_rs_periodicity_slots", "reference_signals.csi_rs_periodicity_slots", "identity"
    "reference_signals.csi_rs_offset_slots", "reference_signals.csi_rs_offset_slots", "identity"
    ...
    "reference_signals.trs.slot_numbers", "reference_signals.trs.slot_numbers", "identity"
    "reference_signals.trs.row_number", "reference_signals.trs.row_number", "identity"
    "reference_signals.trs.symbol_location", "reference_signals.trs.symbol_location", "identity"
    "reference_signals.trs.symbol_locations", "reference_signals.trs.symbol_locations", "identity"
    "reference_signals.trs.burst_length_slots", "reference_signals.trs.burst_length_slots", "identity"
    "reference_signals.trs.period_offset", "reference_signals.trs.period_offset", "identity"
    "reference_signals.trs.subcarrier_location", "reference_signals.trs.subcarrier_location", "identity"
    "reference_signals.trs.rb_offset", "reference_signals.trs.rb_offset", "identity"
    "reference_signals.trs.num_rb", "reference_signals.trs.num_rb", "identity"
    "reference_signals.trs.detection_threshold", "reference_signals.trs.detection_threshold", "identity"
    "reference_signals.trs.min_coverage_ratio", "reference_signals.trs.min_coverage_ratio", "identity"
    "reference_signals.trs.timing_tolerance_samples", "reference_signals.trs.timing_tolerance_samples", "identity"
    "reference_signals.trs.frequency_tolerance_hz", "reference_signals.trs.frequency_tolerance_hz", "identity"
    ...
    "reference_signals.trs_periodicity_slots", "reference_signals.trs_periodicity_slots", "identity"
    ...
    "initial_access", "initial_access", "identity"
    "initial_access.ssb.enabled", "reference_signals.ssb_enabled", "identity"
    "initial_access.mib.enabled", "reference_signals.pbch_enabled", "identity"
    "initial_access.ssb.case", "reference_signals.ssb_case", "identity"
    "initial_access.ssb.scs_khz", "reference_signals.ssb_scs_khz", "identity"
    "initial_access.ssb.lmax", "reference_signals.ssb_lmax", "identity"
    "initial_access.ssb.beam_count", "reference_signals.ssb_beam_count", "identity"
    "initial_access.ssb.periodicity_ms", "reference_signals.ssb_periodicity_ms", "identity"
    "initial_access.sib1.coreset0_from_mib_required", "sib1_and_initial_access.coreset0_from_mib_required", "identity"
    "initial_access.sib1.searchspace0_from_mib_required", "sib1_and_initial_access.searchspace0_from_mib_required", "identity"
    "initial_access.sib1.decode_from_waveform_required", "sib1_and_initial_access.sib1_decode_from_waveform_required", "identity"
    "initial_access.sib1.enabled", "sib1_and_initial_access.sib1_required", "identity"
    "initial_access.ssb.enabled", "sib1_and_initial_access.ssb_required", "identity"
    "initial_access.mib.enabled", "sib1_and_initial_access.mib_required", "identity"
    ...
    "control.coreset_type", "control.coreset_type", "identity"
    "control.search_space_type", "control.search_space_type", "identity"
    "control.dci_formats", "control.dci_formats", "identity"
    "control.blind_decode_candidates", "control.blind_decode_candidates", "identity"
    "control.candidate_aggregation_levels", "control.candidate_aggregation_levels", "identity"
    "control.scheduler_aggregation_level", "control.scheduler_aggregation_level", "identity"
    "control.aggregation_selection_policy", "control.aggregation_selection_policy", "identity"
    "control.search_space_num_candidates", "control.search_space_num_candidates", "identity"
    "control.pdcch_strict", "control.pdcch_strict", "identity"
    ...
    "control.pucch_required", "control_gating.pucch_required", "identity"
    ...
    "random_access.enable_frequency_estimation_metric", "random_access.enable_frequency_estimation_metric", "identity"
    ...
    "random_access.statistical_qualification", "random_access.statistical_qualification", "identity"
    ...
    "modulation.dl_mcs_index", "modulation_and_mapping.dl_mcs_index", "identity"
    "modulation.ul_mcs_index", "modulation_and_mapping.ul_mcs_index", "identity"
    "modulation.mcs_table", "modulation_and_mapping.mcs_table", "identity"
    "modulation.ul_mcs_index", "pusch.mcs_index", "identity"
    ...
    "pusch.execution_profile", "pusch.execution_profile", "identity"
    ...
    "energy.bs_static_power_w", "energy_efficiency.bs_static_power_w", "identity"
    "energy.bs_per_rf_chain_power_w", "energy_efficiency.bs_per_rf_chain_power_w", "identity"
    "energy.bs_sleep_power_w", "energy_efficiency.bs_sleep_power_w", "identity"
    "energy.bs_pa_efficiency", "energy_efficiency.bs_pa_efficiency", "identity"
    "energy.ue_idle_power_w", "energy_efficiency.ue_idle_power_w", "identity"
    "energy.ue_rx_power_w", "energy_efficiency.ue_rx_power_w", "identity"
    "energy.ue_sleep_power_w", "energy_efficiency.ue_sleep_power_w", "identity"
    "energy.ue_tx_dc_per_watt_rf", "energy_efficiency.ue_tx_dc_per_watt_rf", "identity"
    "energy.bs_tx_power_dbm", "energy_efficiency.bs_tx_power_dbm", "identity"
    "energy.ue_tx_power_dbm", "energy_efficiency.ue_tx_power_dbm", "identity"
    "energy.bs_rf_chain_count", "energy_efficiency.bs_rf_chain_count", "identity"
    "energy.ue_rf_chain_count", "energy_efficiency.ue_rf_chain_count", "identity"
