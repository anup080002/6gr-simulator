...
status.ScenarioObjectiveOk = logical(sixgr.util.structGet(scenarioObjective, "ScenarioObjectiveOk", true));
status.StandardsConformanceOk = logical(status.RuntimeTruthContractOk) && status.ActiveMandatoryIssueCount == 0;
