...
sixgr.util.safeFprintf(1, ...
    '[TR38901Plus] Resolved config: Scenario=%s Fc_Hz=%.15g PathlossModel=%s ShadowSigma_dB=%.15g PathlossEnabled=%d ShadowEnabled=%d LOSEnabled=%d\n', ...
