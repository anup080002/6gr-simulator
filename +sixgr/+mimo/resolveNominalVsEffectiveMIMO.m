...
if direction == "DL"
    ...
    tf = metricSource == "measured_tdd_srs_reciprocal_complete_peer_subspace_hybrid_block_diagonalized_precoder_leakage" && ...
        ...
        lower(strtrim(string(row.InterferenceCovarianceSource))) == ...
            "shared_slot_contribution_grid_covariance";
elseif direction == "UL"
    ...
    tf = metricSource == "measured_srs_complete_peer_subspace_irc_receive_projection_leakage" && ...
        evidenceSource == "causal_measured_srs_complete_peer_subspace_and_runtime_irc_covariance" && ...
        matrixDigestPresent && logical(row.MUMIMOReceiveCombinerApplied) && ...
        lower(strtrim(string(row.MUMIMOReceiveCombinerStatus))) == ...
            "applied_exact_scheduler_frozen_projection" && ...
        strlength(appliedDigest) == 64 && ...
        appliedDigest == lower(strtrim(string(row.MUMIMOSpatialFilterMatrixSHA256))) && ...
        ...
        row.MUMIMOReceiveCombinerOutputBranches == row.TransmittedLayers && ...
        contains(receiver, "IRC") && logical(row.InterferenceCovarianceAvailable) && ...
...
row = struct("RunId","", "ScenarioName","", "TrialId",NaN, "Direction","", ...
    ...
    "MUMIMOSpatialFilterMatrixSHA256","", "AppliedPrecoderMatrixSHA256","", ...
