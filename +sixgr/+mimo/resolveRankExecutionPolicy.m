...
policy = lower(strtrim(string(sixgr.util.structGet(cfg, "runtime.link_adaptation.RankPolicy", ...
...
if direction == "UL"
    layerPaths = ["runtime.phy.ul.NumLayers", "phy.pusch.numLayers", "phy.pusch.nLayers"];
    maxRankPaths = ["phy.pusch.maxLayers", "phy.mimo.maxRank", "mimo.max_rank", "mimo.MaxRank"];
    portPaths = ["runtime.phy.ul.NumLogicalPorts", "phy.pusch.NumAntennaPorts", "phy.pusch.numAntennaPorts", ...
    ...
    layerPaths = ["runtime.phy.dl.NumLayers", "phy.pdsch.numLayers", "phy.pdsch.nLayers"];
    maxRankPaths = ["phy.pdsch.maxLayers", "phy.mimo.maxRank", "mimo.max_rank", "mimo.MaxRank"];
    portPaths = ["runtime.phy.dl.NumLogicalPorts", "phy.pdsch.NumAntennaPorts", "phy.pdsch.numAntennaPorts", ...
