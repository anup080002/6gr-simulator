...
csi.CSIReportConfigID = core.CSIReportConfiguration.ReportConfigID;
csi.CSIConfigurationEpoch = core.CSIReportConfiguration.Epoch;
csi.CSIUCIChannel = core.CSIReportConfiguration.UCIChannel;
csi.CSIPart1BitsToken = string(sixgr.runtime.RawCSVArrayCodec.encode(payload.Part1Bits));
csi.CSIPart2BitsToken = string(sixgr.runtime.RawCSVArrayCodec.encode(payload.Part2Bits));
