...
csvMap = struct( ...
    ...
    "msg4_dci_fields", fullfile(layout.ControlCSVDir, "msg4_dci_fields.csv"), ...
...
msg3Decoded.PayloadEvidenceRole = "crc_valid_receiver_decoded_payload";
msg3Decoded.CRCPass = logical(result.Msg3PUSCHCrcPass);
...
msg4Decoded.PayloadEvidenceRole = "crc_valid_receiver_decoded_payload";
msg4Decoded.CRCPass = logical(result.Msg4PDSCHCrcPass);
