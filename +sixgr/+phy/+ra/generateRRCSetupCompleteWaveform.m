...
cfgTx = sixgr.phy.ra.localizeRAPUSCHConfig(cfg, raCfg, setupGrant, ...
...
pusch.RNTI = double(raCfg.FinalCRNTI);
probe = sixgr.phy.ul.PUSCH_Tx(cfgTx, ...
    ...
    "InitialIMCSPerCodeword", double(setupGrant.MCS), ...
...
grant.MCSTable = string(s.MCSTable);
