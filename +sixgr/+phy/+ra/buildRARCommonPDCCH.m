...
%BUILDRARCOMMONPDCCH Build Type1 resources independently at TX and RX.
...
if mod(raCfg.Msg2Slot-offset,period)>=search.Duration || ...
        starts+crst.Duration>carrier.SymbolsPerSlot
...
evidence=struct("Source",source,"SearchSpaceID",search.SearchSpaceID, ...
    "CORESETID",crst.CORESETID,"NCCE",nCCE,"Slot",raCfg.Msg2Slot, ...
