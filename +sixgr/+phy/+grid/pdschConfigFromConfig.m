function pdsch = pdschConfigFromConfig(carrier, cfg, varargin)
%PDSCHCONFIGFROMCONFIG Shared allocation/DM-RS/PT-RS construction.
% This is a configuration factory, not a waveform allocation. Occasion-owned
% reference exclusions belong to allocREsPDSCH; nominal TBS sizing uses this
% same validated factory without claiming actual rate-matched capacity G.
