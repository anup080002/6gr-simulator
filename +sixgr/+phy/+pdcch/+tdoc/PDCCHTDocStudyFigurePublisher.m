classdef PDCCHTDocStudyFigurePublisher
    ...
    methods (Static)
        function row = publish(runRoot, name, source, evidenceClass, configHash, varargin)
            ...
            evidenceClass=sixgr.phy.pdcch.tdoc.PDCCHTDocStudyEvidenceClass.require(evidenceClass);
            sixgr.phy.pdcch.tdoc.PDCCHTDocStudyEvidenceClass.assertPrimaryTruth(source);
