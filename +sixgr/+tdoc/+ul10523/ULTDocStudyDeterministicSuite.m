classdef ULTDocStudyDeterministicSuite
    %DETERMINISTICSUITE Exact/analytical UL study invariants and figure sources.

    methods (Static)
        function out = run()
            checks = sixgr.tdoc.ul10523.ULTDocStudyDeterministicSuite.checks();
            if ~all(checks.Pass)
            ...
            out = struct("Checks", checks, "Sources", ...
                sixgr.tdoc.ul10523.ULTDocStudyDeterministicSuite.figureSources());
        end
