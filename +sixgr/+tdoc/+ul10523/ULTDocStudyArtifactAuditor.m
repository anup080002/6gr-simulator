classdef ULTDocStudyArtifactAuditor
        ...
        function [audit, passed, publicationPassed] = run(runFolder)
            ...
            for idx=1:height(figureManifest)
                ...
                try
                    ...
                    ok=info.Width==double(figureManifest.WidthPx(idx)) && ...
                        ...
                        sixgr.csi.studyFileSHA256(path)==string(figureManifest.PNG_SHA256(idx));
                catch
                    ok=false;
                end
            ...
            if artifactPass
                ...
                for idx=1:height(artifacts)
                    ...
                    ok=exist(path,"file")==2 && sixgr.csi.studyFileSHA256(path)==string(artifacts.SHA256(idx));
