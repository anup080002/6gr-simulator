classdef FigureManifest
    ...
    methods (Static)
        function manifest=replay(runFolder,cfg,context)
            ...
            [specs,contract]=sixgr.csi.FigureContract.load();
            ...
            for k=1:numel(specs)
                ...
                render=sixgr.csi.SemanticFigureRenderer.render(fig,spec,tables,cfg);
                ...
                rows(k)=struct("FigureId",id, ...
                    ...
                    "PlotScript","sixgr.csi.SemanticFigureRenderer."+ ...
                        string(spec.plotter), ...
...
for k=1:numel(sources)
    ...
    hashes(k)=sixgr.csi.fileSHA256(source);
end
end
