...
candidate(3) = "reports/csv/frame_slot_symbol_timing.csv|reports/csv/timing_synchronization_table.csv";
...
candidate(7) = "reports/csv/mapper_input_constellation.csv";
candidate(8) = "reports/csv/per_layer_port_constellation.csv|reports/csv/constellation_samples.csv";
candidate(9) = "reports/csv/phy_signal_diagnostic_source.csv#Panel=time_domain;Series=tx";
candidate(10) = "reports/csv/ofdm_symbol_cp_samples.csv";
...
candidate(13) = "waveform/csv/occupied_bandwidth_emission_mask.csv|rf/csv/spectral_measurements.csv";
candidate(14) = "waveform/csv/papr_ccdf.csv";
...
candidate(20) = "channel/csv/time_varying_channel_impulse_response.csv";
candidate(21) = "reports/csv/phy_signal_diagnostic_source.csv#Panel=channel_estimate_grid";
candidate(22) = "channel/csv/doppler_spectrum.csv|reports/csv/doppler_time_variation_plot.csv";
...
candidate(26) = "mimo/csv/channel_singular_values.csv";
candidate(27) = "mimo/csv/spatial_correlation_matrix.csv";
candidate(28) = "beamforming/csv/beam_pattern_codebook_gain.csv|beamforming/csv/beam_precoder_table.csv";
...
candidate(32) = "control/csv/timing_estimate_residual.csv|reports/csv/timing_synchronization_table.csv";
candidate(33) = "control/csv/cfo_estimate_residual.csv";
...
candidate(36) = "air_interface/csv/channel_estimation_nmse.csv";
candidate(37) = "air_interface/csv/equalizer_weights_posteq_sinr.csv";
...
candidate(40) = "air_interface/csv/llr_reliability_distribution.csv";
candidate(41) = "reports/csv/pre_post_decoder_ber.csv";
candidate(42) = "reports/csv/fixed_snr_sweep_curve_summary.csv|reports/csv/dl_fixed_snr_bler_curve.csv|reports/csv/ul_fixed_snr_bler_curve.csv";
candidate(43) = "air_interface/csv/decoder_convergence_iterations.csv|air_interface/csv/dl_pdsch_trials.csv|air_interface/csv/ul_pusch_trials.csv";
candidate(44) = "air_interface/csv/dl_pdsch_trials.csv|air_interface/csv/ul_pusch_trials.csv";
candidate(45) = "reports/csv/fixed_snr_sweep_curve_summary.csv|reports/csv/throughput_goodput.csv";
candidate(46) = "reports/csv/spectral_efficiency.csv|reports/csv/fixed_snr_sweep_curve_summary.csv";
...
candidate(49) = "beamforming/csv/beam_precoder_table.csv|reports/csv/table_cqi_pmi_ri.csv";
...
gate(13:18) = "powerAndRF.enabled";
gate(23) = "isac.enabled";
gate(34) = "powerAndRF.phaseNoise.enabled";
gate(47) = "harq.enabled";
gate(48) = "linkAdaptation.enabled";
