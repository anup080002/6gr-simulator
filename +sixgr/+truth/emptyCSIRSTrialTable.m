...
row = struct( ...
    ...
    "ReferenceMeasuredSINRStatus","not_attempted","ReferenceMeasuredSINRDomain","", ...
    "AppliedAWGNSNR_dB",NaN,"ReferenceAWGNGridNoiseVariance",NaN, ...
    "ReferenceAWGNSampleNoiseVariance",NaN,"SignalEnergyPerOccupiedRE",NaN, ...
    "SampleToGridNoiseVarianceGain",NaN,"NoiseOperatingMode","", ...
