...
specs = [ ...
    ...
    iSpec("complexity_vs_gain", "reports/image/complexity_vs_gain.png", "air_interface/csv/dl_pdsch_trials.csv", "DecoderIterations", "ReceiverHestSINR_dB", "relation", "runtime_pairs"), ...
