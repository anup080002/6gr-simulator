...
specs = [ ...
    iSpec("bler_vs_measured_sinr", "reports/image/bler_vs_measured_sinr.png", "air_interface/csv/dl_measured_sinr_bler_curve.csv", "PostEqSINR_dB_BinCenter", "BLER", "relation", "measured_posteq_sinr_binning"), ...
    iSpec("throughput_vs_measured_sinr", "reports/image/throughput_vs_measured_sinr.png", "air_interface/csv/dl_measured_sinr_throughput_curve.csv", "PostEqSINR_dB_BinCenter", "Goodput_Mbps_mean", "relation", "measured_posteq_sinr_binning"), ...
    iSpec("nmse_vs_measured_sinr", "reports/image/nmse_vs_measured_sinr.png", "reports/csv/nmse_vs_measured_sinr.csv", "PostEqSINR_dB", "MetricValue", "relation", "measured_posteq_sinr_binning"), ...
    ...
    iSpec("gains_losses_waterfall", "reports/image/gains_losses_waterfall.png", "reports/csv/per_scenario_summary_tables.csv", "ScenarioID", "DL_Goodput_Mbps_mean", "summary", "single_row_summary"), ...
