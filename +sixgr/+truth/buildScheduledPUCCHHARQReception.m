...
assert(isempty(rrc.Data.SRResources), ...
    'sixgr:truth:UnresolvedSRPUCCHReceiveHypothesis', ...
    'HARQ-only receive ownership requires an explicitly empty installed SR resource list.');
context=sixgr.phy.pucch.UCIReportContext(struct( ...
    'ReportID',string(observationID),'ConfigurationEpoch',mapping.ConfigurationEpoch, ...
    'Sequence1Length',mapping.BitCount,'Sequence2Length',0,'HARQACKBits',mapping.BitCount, ...
