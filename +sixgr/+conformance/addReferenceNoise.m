...
gridNoiseVariance = 10.^(-requestedEsN0_dB / 10);
...
provenance = struct( ...
    ...
    "SNRDefinition", ...
        "Es/N0 for unit-energy QAM on occupied grid RE; N0 is complex grid-domain noise variance after OFDM demodulation", ...
    ...
    "VarianceEquation", ...
        "sampleNoiseVariance = 10^(-RequestedEsN0_dB/10) / SampleToGridNoiseVarianceGain", ...
