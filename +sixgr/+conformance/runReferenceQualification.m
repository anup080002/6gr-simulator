...
for index = 1:numel(entries)
    ...
    checkpoint = struct( ...
        "SchemaVersion", "sixgr.conformance.reference_checkpoint/v1", ...
        "EntryId", entryId, ...
...
required = ["SchemaVersion", "EntryId", "IdentitySHA256", "Identity", "Row"];
...
if string(checkpoint.SchemaVersion) ~= ...
        "sixgr.conformance.reference_checkpoint/v1" || ...
