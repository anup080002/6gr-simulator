...
out.PBCH = struct("Ok", logical(rec.BCHCrcPass), "ErrFlag", double(~logical(rec.BCHCrcPass)), ...
    ...
    "SS_RSRP_dB_re_UnitOccupiedRE_Es", double(sixgr.util.structGet( ...
        rec, "SS_RSRP_dB_re_UnitOccupiedRE_Es", NaN)), ...
...
for field=["SS_RSRPPerReceiveAntenna_dB_re_UnitOccupiedRE_Es", ...
...
out.SSBIndex = double(rec.ObservedSSBOccasionIndex);
out.ObservedSSBOccasionIndex = double(rec.ObservedSSBOccasionIndex);
out.PBCHHypothesisSSBIndex = double(rec.PBCHHypothesisSSBIndex);
out.SSBIdentityVerified = logical(rec.SSBIdentityVerified);
out.SSBIndexSource = string(rec.SSBIndexSource);
...
out.SS_RSRP_dB_re_UnitOccupiedRE_Es = double(sixgr.util.structGet( ...
    rec, "SS_RSRP_dB_re_UnitOccupiedRE_Es", NaN));
out.SS_RSRPRawObserved_dB_re_UnitOccupiedRE_Es = double( ...
    sixgr.util.structGet(rec, ...
    "SS_RSRPRawObserved_dB_re_UnitOccupiedRE_Es", NaN));
...
out.ReferenceSignalTxEPRE_dB_re_UnitOccupiedRE_Es = double( ...
    sixgr.util.structGet(rec, ...
    "ReferenceSignalTxEPRE_dB_re_UnitOccupiedRE_Es", NaN));
out.MeasuredReferenceSignalChannelGain_dB = double(sixgr.util.structGet( ...
    rec, "MeasuredReferenceSignalChannelGain_dB", NaN));
...
out.ResidualCFOMeasurementStatus = "unavailable_no_post_correction_residual_estimator";
