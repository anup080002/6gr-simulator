...
if isstruct(out.HARQ)
    ...
    if independentUCI
        ...
        out.HARQ.IndependentUCICompletionFlags=struct( ...
            'NoiseVarStrictFailure',trialNoiseVarStrictFailure(finalTrialIndex), ...
            'DecodeAttempted',trialDecodeAttempted(finalTrialIndex), ...
            'ULSCHDecodeAttempted',trialULSCHDecodeAttempted(finalTrialIndex), ...
            'ReceiverUsable',trialReceiverUsable(finalTrialIndex));
...
preserveFields = ["UEIndex","RNTI","ServingCell","CQIUsed","RIUsed","PMI","CRI","MCSTable","CQITable","AMCMode", ...
    ...
    "UCIOnPUSCHFeedbackHARQIds","UCIOnPUSCHFeedbackBitCount","UCIOnPUSCHFeedbackBitIndices", ...
    ...
    "DCI","ULTotalDAIAuthority","Valid","GrantBlocker","ExactPHYFeasibilityChecked","ExactPHYFeasible", ...
