...
[rxWaveform, desiredWaveform, injectedNoise, noiseVariance, ...
    ...
    cfgRuntime,tx,opt);
signalPower = localFiniteWaveformPower(desiredWaveform);
measuredNoisePower = localFiniteWaveformPower(injectedNoise);
...
function replay = localAttachInterferenceReplay( ...
        replay,meta,interferenceWaveform)
...
replay.InterferenceWaveformVariance = localFiniteWaveformPower( ...
    interferenceWaveform);
...
switch mode
    case "standalone_awgn_snr_argument"
        ...
        [waveform,reference] = sixgr.conformance.addReferenceNoise( ...
...
try
    ...
    rawPower = localFiniteWaveformPower(rawWaveform);
    appliedPower = localFiniteWaveformPower(tx.Waveform);
