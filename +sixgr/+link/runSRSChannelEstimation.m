...
out.PredictedPUSCHReferenceSignalPower = NaN;
out.PredictedPUSCHDisturbancePower = NaN;
out.PUSCHToSRSReferenceEnergyRatio = NaN;
out.PUSCHToSRSReferenceEnergySource = "";
...
try
    ...
    out.InjectedSampleNoiseVarianceSource = string(sixgr.util.structGet( ...
    ...
    energyRatio = NaN;
    energySource = "";
    % This is the same installed authority used by applyPowerContext for
    ...
    srsULCSI = sixgr.phy.ul.estimateSRSRITPMI(rx.Hest, rx.NoiseVar, cfgSRS, ...
        ...
        "ReferenceSignalPower",linkState.ReferenceSignalPower, ...
        "ReferencePowerSource",linkState.ReferencePowerSource, ...
        "PUSCHToSRSReferenceEnergyRatio",energyRatio, ...
        "PUSCHToSRSReferenceEnergySource",energySource);
    out.PredictedPUSCHReferenceSignalPower = srsULCSI.SelectedReferenceSignalPower;
    out.PredictedPUSCHDisturbancePower = srsULCSI.SelectedDisturbancePower;
    out.PUSCHToSRSReferenceEnergyRatio = srsULCSI.SelectedPUSCHToSRSReferenceEnergyRatio;
    out.PUSCHToSRSReferenceEnergySource = srsULCSI.SelectedPUSCHToSRSReferenceEnergySource;
...
trusted = isfinite(sinr_dB) && ...
    sinrSource == "receiver_measured_srs_reference_power_selected_ri_tpmi_mmse_layer_prediction" && ...
    lower(sinrRole) == ...
