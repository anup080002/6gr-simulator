...
row.ReferenceSINRMeasurementJSON=string(sixgr.util.structGet(rxObs,"ReferenceSINRMeasurementJSON",""));
row.ChannelEstimateDiagnosticSINR_dB=double(sixgr.util.structGet(rxObs,"ChannelEstimateDiagnosticSINR_dB",NaN));
row.ChannelEstimateDiagnosticSINRSource=string(sixgr.util.structGet(rxObs,"ChannelEstimateDiagnosticSINRSource",""));
...
if fixedNormalizedEsN0
    row.TxMeasurementRSRP_dB_re_UnitOccupiedRE_Es = ...
        sixgr.phy.refsig.convertCSIRSPowerToUnitRE(row.TxMeasurementRSRP_dBm, ...
        txRSMeasurement.Nfft,txRSMeasurement.GridScaleToSqrtW);
    row.TxMeasurementRSRPPerAntenna_dB_re_UnitOccupiedRE_Es = ...
        sixgr.phy.refsig.convertCSIRSPowerToUnitRE(row.TxMeasurementRSRPPerAntenna_dBm, ...
        txRSMeasurement.Nfft,txRSMeasurement.GridScaleToSqrtW);
...
row = struct( ...
    ...
    "ReferenceSINRMeasurementJSON","","ChannelEstimateDiagnosticSINR_dB",NaN, ...
    "ChannelEstimateDiagnosticSINRSource","", ...
...
row.ElementPatternChannelApplicability = string(channelMeta.ElementPatternChannelApplicability);
row.AntennaChannelConsistencyStatus = string(channelMeta.AntennaChannelConsistencyStatus);
row.AntennaChannelConsistencyReason = string(channelMeta.AntennaChannelConsistencyReason);
...
meta.ChannelUsesCountOnlyAntennaModel = logical(sixgr.util.structGet(metaIn, "ChannelUsesCountOnlyAntennaModel", ...
    strcmpi(strtrim(string(meta.ChannelArrayModel)), "nrtdl_count_only_fading_channel")));
...
meta.ElementPatternChannelApplicability = string(sixgr.util.structGet(metaIn, "ElementPatternChannelApplicability", ""));
meta.AntennaChannelConsistencyStatus = string(sixgr.util.structGet(metaIn, "AntennaChannelConsistencyStatus", ""));
meta.AntennaChannelConsistencyReason = string(sixgr.util.structGet(metaIn, "AntennaChannelConsistencyReason", ""));
