function artifacts=writeRACHTDocStudyMeasuredArtifacts(runFolder,strict,campaign,classification)
...
meta=struct("artifact_id",id,"classification",classification,"status","COMPLETE", ...
    ...
    "producer","sixgr.rach.tdoc10512.writeRACHTDocStudyMeasuredArtifacts");
