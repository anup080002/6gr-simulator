function result = runCampaign(configPath,varargin)
...
campaign=sixgr.rach.tdoc10512.buildCampaignConfig(configPath);
...
if resume
    ...
    schemaReport=sixgr.rach.tdoc10512.validateCampaignConfig(cfg);
...
if resume
    ...
    [analyticalArtifacts,analyticalData]= ...
        sixgr.rach.tdoc10512.generateAnalyticalArtifacts( ...
...
if any(mode==["smoke","engineering_lls"])
    ...
    measuredPrachArtifacts=sixgr.rach.tdoc10512.writeStrictMeasuredArtifacts( ...
        runFolder,strict,campaign,localModeClassification(cfg,mode));
end
if mode=="engineering_lls"
    engineering=sixgr.rach.tdoc10512.runEngineeringEvidence( ...
        internal,campaign,runFolder,runID);
    supplemental=sixgr.rach.tdoc10512.runSupplementalEvidence( ...
...
meta=struct("artifact_id",id,"classification","QUICK_SANITY_MODEL", ...
    ...
    "performance_claim",false,"producer","sixgr.rach.tdoc10512.runCampaign");
