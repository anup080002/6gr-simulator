function out = runZCDPELLS(baseCfg, varargin)
%RUNZCDPELLS Execute a ZC-DPE PRACH LLS study.

p = inputParser;
p.FunctionName = "sixgr.rach.runZCDPELLS";
...
elseif isobject(baseCfg)
    ...
    error("sixgr:rach:runZCDPELLS:BadInput", "Unsupported base PRACH config input.");
end
end
