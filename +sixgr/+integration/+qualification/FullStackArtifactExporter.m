classdef FullStackArtifactExporter
    ...
    methods (Static)
        ...
        function T=writeRunManifest(ctx,finalStatus,exitCode,varargin)
            parser=inputParser;
            addParameter(parser,"FinalManifestComplete",false,@islogical);
            addParameter(parser,"PublicationComplete",false,@islogical);
            ...
            T=table(ctx.RunID,ctx.Profile.Preset,ctx.ScenarioID, ...
                ...
                endUTC,double(exitCode),string(finalStatus), ...
                parser.Results.FinalManifestComplete, ...
                parser.Results.PublicationComplete,status, ...
                ...
                'ExitCode','FinalStatus','FinalManifestComplete', ...
                'PublicationComplete','Status'});
            sixgr.util.csvWriteTable(fullfile(ctx.CSVDir, ...
