...
defs(end+1, 1) = localRegistryRow("PRACH", "random_access", "TS 38.211/38.321 PRACH and random access", prachEnabled, prachEnabled, ...
    ["sixgr.phy.prach.runStrictPRACHValidation","sixgr.rach.generatePRACHWaveform"], "control/csv/prach_trials.csv", "control/csv/prach_trials.csv|control/csv/prach_negative_trials.csv", "control/csv/prach_trials.csv"); %#ok<AGROW>
defs(end+1, 1) = localRegistryRow("PDCCH", "control", "TS 38.212 DCI/CORESET/search-space processing", pdcchEnabled, pdcchEnabled, ...
    ["sixgr.phy.pdcch.runStrictPDCCHValidation","sixgr.phy.dl.PDCCH_Rx"], "control/csv/pdcch_trials.csv", "control/csv/pdcch_trials.csv|control/csv/pdcch_wrong_rnti_trials.csv", "control/csv/pdcch_trials.csv"); %#ok<AGROW>
...
defs(end+1, 1) = localRegistryRow("PUCCH_UCI", "uplink_control", "TS 38.213 PUCCH/UCI feedback", pucchEnabled, pucchEnabled, ...
    ["sixgr.phy.ul.PUCCH_Rx"], "air_interface/csv/pucch_trials.csv", "air_interface/csv/pucch_trials.csv", "air_interface/csv/pucch_trials.csv"); %#ok<AGROW>
defs(end+1, 1) = localRegistryRow("SRS", "reference_signal", "TS 38.211 SRS channel sounding", srsEnabled, srsEnabled, ...
    ["sixgr.phy.srs.runStrictSRSValidation"], "reference_signals/csv/srs_trials.csv", "reference_signals/csv/srs_trials.csv|reference_signals/csv/srs_negative_trials.csv", "reference_signals/csv/srs_trials.csv"); %#ok<AGROW>
defs(end+1, 1) = localRegistryRow("TRS", "reference_signal", "TS 38.211 TRS tracking", trsEnabled, trsEnabled, ...
    ["sixgr.phy.trs.runStrictTRSValidation"], "reference_signals/csv/trs_trials.csv", "reference_signals/csv/trs_trials.csv|reference_signals/csv/trs_negative_trials.csv", "reference_signals/csv/trs_trials.csv"); %#ok<AGROW>
defs(end+1, 1) = localRegistryRow("MIMO", "mimo_beamforming", "TS 38.214 rank/layer/precoder evidence", mimoEnabled, mimoEnabled, ...
    ["sixgr.mimo.resolveNominalVsEffectiveMIMO"], "beamforming/csv/rank_layer_trials.csv", "beamforming/csv/rank_layer_trials.csv", "beamforming/csv/rank_layer_trials.csv"); %#ok<AGROW>
