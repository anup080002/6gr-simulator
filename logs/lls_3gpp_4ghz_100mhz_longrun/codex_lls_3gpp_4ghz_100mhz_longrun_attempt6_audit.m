...
setenv('MYSQL_DATABASE','sixgr_results');
setup6GRSimToolkit('Verbose',false,'RunToolboxChecks',false);
out=run_6g_phy_lls_single('simulator/configs/scenarios/lls_3gpp_4ghz_100mhz_longrun.yaml','results','codex_lls_3gpp_4ghz_100mhz_longrun_attempt6_audit');
