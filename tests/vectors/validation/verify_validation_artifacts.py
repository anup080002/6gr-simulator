...
CSV_CONTRACT=PACK/"desired_validation_csv_contract.csv"
IMG_CONTRACT=PACK/"desired_validation_image_contract.csv"
AUDIT_NAME="validation_image_semantic_audit.csv"
