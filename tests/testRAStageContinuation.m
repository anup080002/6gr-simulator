...
for index = 1:5
    ...
    assert(transmission.StartTime_s == transmission.AbsoluteSlot * sixgr.time.slotDurationSec(cfg) && ...
        ...
        'A pending stage must carry the exact absolute interval of its actual sample buffer.');
