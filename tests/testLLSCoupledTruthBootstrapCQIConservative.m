...
cfg = sixgr.util.structSet(cfg, "phy.linkAdaptation.bootstrapCQIMode", "conservative");
...
assert(double(fb.RI) == 1, ...
    "Conservative bootstrap RI must stay rank-1 until measured RI is available.");
