...
PAYLOAD = (
    ...
    "EqualizedImag,SymbolEVM_rms,TruthStatus\n"
    "DL,1,1,6,1,1,0,3,1,0,1.1,0,0.1,real_lls_evidence\n"
    "DL,1,1,6,1,1,0,3,3,0,3.9,0,0.3,real_lls_evidence\n"
    "DL,1,1,7,2,1,0,3,1,0,1.5,0,0.5,real_lls_evidence\n"
    "DL,2,1,6,1,1,0,3,1,0,1.8,0,0.8,real_lls_evidence\n"
).encode()
...
def test_direction_specific_evm_keeps_zero_and_single_symbol_observations():
    ...
    payload = header + b"DL,1,1,6,1,1,0,3,1,0,1,0,0,real_lls_evidence\n" + b"UL,1,1,9,2,1,0,1,1,0,1.3,0,0.3,real_lls_evidence\n"
    existing = {path: {"artifact_id": 1, "logical_path": path}}
