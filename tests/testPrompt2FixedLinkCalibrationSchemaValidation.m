...
masterCfg = sixgr.lls6g.config.loadScenarioConfig(fullfile(repoRoot, ...
    "simulator", "configs", "scenarios", "master_scenaio_all_file.yaml"));
assert(strlength(masterCfg.ScenarioID) > 0, "Master scenario should continue to load.");
