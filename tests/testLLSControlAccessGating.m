...
assert(strcmpi(string(annotatedFull.SourceClassification(1)), "active_integrated") && ...
        strcmpi(string(annotatedFull.RuntimeMaterializationStatus(1)), "active_integrated_four_step_ra_waveform_terminated_at_msg1_detection"), ...
    ["A failed full four-step RA attempt with real Msg1 evidence must retain integrated provenance " + ...
    "and must not be mislabeled as a completed Msg1-Msg4 procedure."]);
