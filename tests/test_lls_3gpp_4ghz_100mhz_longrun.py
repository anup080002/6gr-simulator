...
SCENARIO = "lls_3gpp_4ghz_100mhz_longrun.yaml"
...
def main() -> None:
    ...
    assert raw["run_control"]["total_slots"] == 50000
    assert raw["run_control"]["warmup_slots"] == 5000
    assert raw["run_control"]["measurement_slots"] == 45000
    ...
    assert chain
    assert dash.path_get(resolved, "meta.scenario_id") == "lls_3gpp_4ghz_100mhz_longrun"
