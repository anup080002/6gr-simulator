...
[audit,passed]=sixgr.csi.auditTDocStudyRun(folder);
...
sixgr.csi.runCSITDocStudySuite("figure_replay","RunFolder",string(folder));
F=readtable(fullfile(folder,"manifests","figure_manifest.csv"), ...
    "Delimiter",",","VariableNamingRule","preserve");
...
[imageAudit,imagePassed]=sixgr.csi.auditTDocStudyFrameImages(folder);
