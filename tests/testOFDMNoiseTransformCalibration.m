...
[rxDL, ~] = sixgr.phy.dl.PDSCH_Rx(txDL.Waveform, cfg, ...
    ...
    "RV", txDL.RV, "NoiseVar", sampleNoiseVar, "NoiseVarDomain", "time", ...
...
[txPUCCH, txPUCCHInfo] = sixgr.phy.ul.PUCCH_Tx(cfgCtrl, int8(1), "Format", 1);
[rxPUCCH, ~] = sixgr.phy.ul.PUCCH_Rx(txPUCCH.Waveform, cfgCtrl, ...
    "Carrier", txPUCCH.Carrier, "PUCCH", txPUCCH.PUCCH, ...
    "Format", txPUCCHInfo.Format, "NumUCIBits", 1, ...
    "ExpectedUCIBits", int8(1), "NoiseVar", sampleNoiseVar, ...
    "NoiseVarDomain", "time");
...
[expectedPUCCHGridVar, ~] = sixgr.phy.waveform.convertNoiseVarianceToGridDomain(sampleNoiseVar, pucchInfo, ...
    "InputDomain", "time");
localAssertNear(double(rxPUCCH.NoiseVar), expectedPUCCHGridVar, "PUCCH");
end
