...
assert(all(string(T.DL_BLER_CI_Method) == "clopper_pearson_exact") && ...
    all(string(T.UL_BLER_CI_Method) == "clopper_pearson_exact"), ...
    "BLER confidence intervals must use the fixed-link exact binomial method.");
