...
cfg.run.seed = 4309;
cfg.run.runTag = "core_persistence_fixture";
cfg.run.executionID = "core_persistence_fixture_execution";
cfg.run.scenarioID = "core_persistence_fixture";
cfg.meta.executionID = cfg.run.executionID;
cfg.meta.scenarioID = cfg.run.scenarioID;
cfg.meta.lls6gScenarioID = cfg.run.scenarioID;
cfg.meta.configHash = string(sixgr.util.sha256Hex( ...
    uint8(unicode2native('core_persistence_fixture_config_v1', 'UTF-8'))));
