...
dl.WideCellMatrix = {int8(1), "alpha"; int8(2), "beta"};
anchor = dl(1, :);
...
indexT = readtable(snapshot.IndexPath, "Delimiter", ",", ...
...
rawT = readtable(fullfile(fileparts(snapshot.IndexPath), ...
    char(indexT.RelativePath)), "Delimiter", ",", ...
    "TextType", "string", "VariableNamingRule", "preserve");
...
assert(contains(indexT.EncodedColumns, "PerLayerMetric") && ...
    ...
    contains(indexT.EncodedColumns, "WideCellMatrix"));
...
assert(isequal(sixgr.runtime.RawCSVArrayCodec.decode(rawT.WideCellMatrix(1)), ...
    {int8(1), "alpha"}));
assert(isequal(sixgr.runtime.RawCSVArrayCodec.decode(rawT.WideCellMatrix(2)), ...
    {int8(2), "beta"}));
...
fixedIndex = readtable(fixedSnapshot.IndexPath, "Delimiter", ",", ...
    "TextType", "string", "VariableNamingRule", "preserve");
