...
assert(contains(source, '"Required", browserPublicationRequired'), ...
    "The terminal runner must bind browser-closure fatality to the resolved " + ...
    "BrowserPublicationRequired policy.");
