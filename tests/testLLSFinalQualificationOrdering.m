...
assert(contains(closureSource, "forceMaterialization = passIndex > 1") && ...
    contains(closureSource, '"ReplaceExistingRastersFromCSV", false'), ...
    "Terminal fixed-point passes must use exact source-cache reuse and must " + ...
    "not repeatedly delete/rebuild producer-owned scientific rasters.");
