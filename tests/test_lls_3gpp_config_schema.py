...
def main() -> None:
    ...
    assert payload["properties"]["run_control"]["properties"]["total_slots"]["const"] == 50000
    assert payload["properties"]["run_control"]["properties"]["measurement_slots"]["const"] == 45000
