...
dlNoOccasion = sixgr.link.runDLPDSCHThroughput(cfgNoOccasion, ...
    ...
    "StartFrameIndex", 1, "StartSlotIndex", 10, ...
...
grant = struct( ...
    ...
    "ControlDecodeOk", true, "PDCCHGrantBindingRequired", true, ...
    "PDCCHGrantBindingOk", true, "PDCCHGrantBindingStatus", "pass", ...
    "PDCCHGrantDCIId", "DL-strict-csi-nonoccasion-dci", ...
    "PDCCHGrantDCIFieldsHash", "strict_csi_nonoccasion_exact_grant", ...
    "PDCCHGrantFieldsHash", "strict_csi_nonoccasion_exact_grant", ...
    "DCICrcPass", true, "PDCCHPayloadMatch", true, ...
    "PDCCHCausalGrantDecodeOk", true, "GrantValid", true, ...
    "GrantContextId", "DL|strict-csi-nonoccasion|frame=1|slot=10", ...
