...
assert(isequal(double(payloadAdv(:)), ...
    [double(detailsAdv.DCI11PayloadBits); double(detailsAdv.DCI01PayloadBits)]) && ...
    all(double(payloadAdv(:)) > 44), ...
    "Advanced DCI payload sizing must preserve one exact size per contextual format.");
