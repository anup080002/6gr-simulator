...
result = sixgr.phy.pdcch.PDCCHReceiver.receive( ...
    ...
    "ControlBeamState", localBeamState(), ...
...
wrongQCL = e;
wrongQCL.QCLSourceID = e.QCLSourceID + 1;
localAssertError(@() sixgr.phy.pdcch.DecodedGrantMaterializer.materialize( ...
    sixgr.phy.pdcch.DecodedDCIEvent(wrongQCL), state), ...
    "sixgr:phy:pdcch:inactive_tci_state");
wrongQCL = e;
wrongQCL.QCLSourceType = "unrelated_reference";
localAssertError(@() sixgr.phy.pdcch.DecodedGrantMaterializer.materialize( ...
    sixgr.phy.pdcch.DecodedDCIEvent(wrongQCL), state), ...
    "sixgr:phy:pdcch:inactive_tci_state");
