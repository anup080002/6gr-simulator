...
assert(relative.SS_RSRP_dB_re_UnitOccupiedRE_Es==-5 && ...
    relative.SS_RSRPPerReceiveAntenna_dB_re_UnitOccupiedRE_Es=="-5;-6" && ...
    relative.MeasuredReferenceSignalChannelGain_dB==-5 && isnan(relative.SS_RSRP_dBm) && ...
