...
assert(double(cfg.phy.linkAdaptation.outageRecoveryPositiveCQIReports) == 2);
assert(double(cfg.phy.linkAdaptation.outageRecoveryCQITolerance) == 1);
assert(double(cfg.phy.linkAdaptation.outageRecoveryMaxGapSlots) == 5);
assert(double(cfg.phy.linkAdaptation.rankIncreaseConfirmationReports) == 2);
