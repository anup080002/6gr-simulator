...
[expectedCQI,expectedPMI,~,expectedPMIInfo] = ...
...
% PUCCH wideband Type-I has one padded payload; it must not invent a
% second part to satisfy a PUSCH fixture assertion (38.212 Table -7).
[pucch,pucchSchema]=actual.CSIReportConfiguration.transcode( ...
    actual.CSIPart1Bits,actual.CSIPart2Bits,"PUCCH");
