...
fprintf(fid, "%s", ['{' ...
    ...
    '"simulation":{"n_frames":1,"n_slots":5,"n_subframes":3,"monte_carlo_iterations":1,"random_seed":73040,"snr_db":24,"snr_sweep_offsets_db":[0],"noise_operating_mode":"receiver_noise_figure_thermal_noise"},' ...
    ...
    '"random_access":{"detection_threshold":0.2,"min_detection_trials":1},' ...
    ...
    '"reference_signals":{"channel_state_information_mode":"PMI+CQI","csi_feedback_mode":"PMI+CQI","cqi_reporting_enabled":true,"pmi_reporting_enabled":true,"ri_reporting_enabled":false,"cri_reporting_enabled":false,"csi_rs_precoder_codebook":{"enabled":true,"type":"dft_ura","physical_element_count":4,"beam_indices_port_0":[0],"beam_indices_port_1":[1]}},' ...
    '"initial_access":{"ssb":{"precoder_codebook":{"enabled":true,"type":"dft_ura","physical_element_count":4,"beam_grid_rows":2,"beam_grid_columns":4,"beam_indices":[0,1,2,3,4,5,6,7]}}},' ...
