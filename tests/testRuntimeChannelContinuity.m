...
assert(replayA1.RuntimeChannelObjectClockExact && ...
    replayA2.RuntimeChannelObjectClockExact && ...
    stateA.TotalObjectInputSamples - stateA.WarmupSamples == ...
    stateA.CurrentSampleIndex && ...
    replayA1.RuntimeChannelCanonicalInputSamples == size(x, 1) && ...
    replayA2.RuntimeChannelCanonicalInputSamples == size(x, 1), ...
    ["Channel-tail lookahead must not advance the canonical fading object " ...
     "beyond the logical runtime sample clock."]);
if stateA.ChannelPadSamples > 0
    assert(replayA1.RuntimeChannelAlignmentLookaheadExecutedOnFork && ...
        replayA1.RuntimeChannelAlignmentLookaheadSamples == ...
        stateA.ChannelPadSamples, ...
        "Alignment tail samples must execute only on a disposable post-grant fork.");
end
